...
<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ Auth::user()?->hasLocalPassword() ? __('Ensure your account is using a long, random password to stay
            secure.') : __('Set a password so you can still sign in even if GitHub is disconnected.') }}
        </p>
    </header>
