        ...
        <div class="flex items-center gap-4">
            @auth
                ...
                <div class="relative inline-block text-left" id="profile-dropdown-container">
                    ...
                    <div id="profile-menu" class="hidden absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-xl bg-white py-2 shadow-lg ring-1 ring-slate-900/5 focus:outline-none" role="menu">
                        ...
                        <a href="{{ route('profile') }}" class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 hover:text-blue-700 transition" role="menuitem">Profil</a>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="block w-full text-left px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 hover:text-blue-700 transition" role="menuitem">Keluar</button>
                        </form>
                    </div>
                </div>
            ...
            @else
                ...
                @if (Route::has('register'))
                    <a href="{{ route('register') }}" class="inline-flex items-center justify-center rounded-md bg-blue-800 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700">
                        Daftar
                    </a>
                @endif
            @endauth
